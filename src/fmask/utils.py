...
def gen_slope(profile, des=None, nthreads=1):
    ...
    return warp2like(src=os.path.join(_get_data_root(), "data", "global_gt30_slope.tif"), like=profile, des=des, nthreads=nthreads)/100
...
def gen_aspect(profile, des=None, nthreads=1):
    ...
    return warp2like(src=os.path.join(_get_data_root(), "data", "global_gt30_aspect.tif"), like=profile, des=des, nthreads=nthreads)/100
